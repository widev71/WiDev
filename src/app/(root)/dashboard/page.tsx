...
const DashboardsPage = async () => {
  ...
  return (
    ...
    <div className="p-6">
      ...
      <div className="space-y-3 p-6 mb-8 rounded-2xl bg-white/5 dark:bg-black/10 backdrop-blur-[2px] border border-white/20 dark:border-white/10 shadow-lg shadow-black/10 dark:shadow-white/10">
      ...
      <div className="space-y-3 p-6 rounded-2xl bg-white/5 dark:bg-black/10 backdrop-blur-[2px] border border-white/20 dark:border-white/10 shadow-lg shadow-black/10 dark:shadow-white/10">
        < h4 className="flex gap-3 items-center font-normal">
